...
public class AspectConfiguration {
    @Around("execution(* com.services.*.*(org.springframework.data.domain.Pageable, ..))") // pointcut expression only apply with these methods service has first parameter type is Pageable
